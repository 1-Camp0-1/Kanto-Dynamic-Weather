...
local WEATHER = {
  clear =        { coverage=0.00, cell=185, gate=1.01, span=0.92, puffs=0.70, bank=0.30, rays=1.10, shadow=0.00, cloudShade=1.02, fog=0.72 },
  partly =       { coverage=0.25, cell=185, gate=0.18, span=1.00, puffs=1.00, bank=0.34, rays=1.00, shadow=1.00, cloudShade=1.00, fog=1.00 },
  mostly =       { coverage=0.75, cell=120, gate=0.08, span=1.08, puffs=0.74, bank=0.46, rays=0.88, shadow=1.18, cloudShade=0.94, fog=1.05 },
  ...
  cloudy =       { coverage=0.92, cell=110, gate=0.015, span=1.16, puffs=0.84, bank=0.72, rays=0.55, shadow=1.34, cloudShade=0.86, fog=1.08,
  ...
  overcast =     { coverage=1.00, cell=108, gate=-0.01, span=1.24, puffs=0.94, bank=1.00, rays=0.08, shadow=1.46, cloudShade=0.76, fog=1.10,
                   closedDeck=true, deckWidth=1.82, deckDepth=1.12, deckY0=116, deckYSpan=26,
                   skyBlend=0.90, skyColor={0.55,0.59,0.64} },
  rain =         { coverage=1.00, cell=105, gate=-0.01, span=1.28, puffs=0.98, bank=1.00, rays=0.05, shadow=1.58, cloudShade=0.66, fog=1.20, motes=0.00, storm=0.00,
                   ...
                   skyBlend=0.94, skyColor={0.44,0.49,0.55} },
  thunderstorm = { coverage=1.00, cell=102, gate=-0.01, span=1.34, puffs=1.02, bank=1.00, rays=0.015, shadow=1.72, cloudShade=0.52, fog=1.30, motes=0.00, storm=1.00,
                   ...
                   skyBlend=0.97, skyColor={0.31,0.35,0.43} },
}
...
function CinematicAtmos.frame(map, outdoor)
  ...
  if canopy then
    ...
    dens, start, heightK = 0.00285 * level, 50, 0.017
  else
    ...
    dens, start, heightK = 0.00105 * level * (weather.fog or 1.0), 126, 0.0085
  end
  return {
    level = level,
    canopy = canopy,
    ...
    lightning = lightning,
    lightIntensity = lightScale() * (weather.rays or 1.0),
    ...
    fog = { color = fogColor, density = dens, start = start, heightK = heightK,
            startFromFocus = canopy and -28 or -18 },
